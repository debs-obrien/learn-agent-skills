...
```
Run the check script against the generated README.
```

```bash
bash .agents/skills/readme-wizard/scripts/check_readme.sh README.md
```
...
Want to compare your skill against ours? Check out the finished [README Wizard skill](https://github.com/debs-obrien/learn-agent-skills) with all the files, scripts, and examples.
